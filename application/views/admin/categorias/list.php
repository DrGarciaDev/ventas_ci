...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-solid">
            ...
            <?php if ($this->session->flashdata('cat_act')) { ?>
                <div class="alert alert-warning alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <p><i class="icon fa fa-exclamation"></i><?php echo $this->session->flashdata('cat_act'); ?></p>
                </div>
            <?php } ?>
            <?php if ($this->session->flashdata('cat_agr')) { ?>
                <div class="alert alert-success alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <p><i class="icon fa fa-exclamation"></i><?php echo $this->session->flashdata('cat_agr'); ?></p>
                </div>
            <?php } ?>
            <?php if ($this->session->flashdata('cat_elim')) { ?>
                <div class="alert alert-danger alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <p><i class="icon fa fa-exclamation"></i><?php echo $this->session->flashdata('cat_elim'); ?></p>
                </div>
            <?php } ?>
            <hr>
            <div class="row">
